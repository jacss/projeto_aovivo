...
<div class="conteiner">
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 79%; margin-top: -20px;">
                <a v-if="criar && !modal" v-bind:href="criar">Criar</a>
                <modallink v-if="criar && modal" tipo="link" nome="adicionar" titulo="Criar" css=""></modallink>
            </td>
            <td>
                <input type="search" class="form-control" placeholder="Buscar" v-model="buscar" style="margin-bottom: 20px;"/>
            </td>
        </tr>
    </table>
                       ...
                       <tr v-for="(item,index) in lista" :key="item.id" >
                          <td v-for="i in item">{{i}}</td>
                           ...
                           <td v-if="detalhe || editar || deletar">
                                ...
                                <modallink v-if="editar && modal" v-bind:item="item" tipo="link" v-bind:url="editar" nome="editar" titulo="Editar|" css=""></modallink>
